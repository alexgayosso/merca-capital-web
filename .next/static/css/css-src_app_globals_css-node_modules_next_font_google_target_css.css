...
:host {
  ...
  -o-tab-size: 4;
     tab-size: 4; /* 3 */
  font-family: var(--font-inter), -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, sans-serif; /* 4 */
...
/* ============================================
   MERCA CAPITAL - GLOBAL STYLES
   Navy Deep (#000B29) + Copper (#C08A3E)
   ============================================ */
...
::-moz-selection {
  background-color: rgba(192, 138, 62, 0.3);
  color: #FFFFFF;
}
